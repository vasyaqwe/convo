...
export function ChatButton({
    ...
    return (
        <button
            ...
            className={cn(
                "flex w-full items-center rounded-lg p-2 text-start transition-all duration-300 hover:bg-secondary aria-[current=page]:bg-secondary max-md:active:scale-[102%]",
                className
            )}
            {...props}
        >
